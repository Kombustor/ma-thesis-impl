import type { Content } from '@prisma/client-platform';
...
const H1_CLASSES = classNames('mb-4 text-2xl lg:text-3xl');
const H2_CLASSES = classNames('mt-5 text-xl lg:text-2xl');
const H3_CLASSES = classNames('mt-4 text-lg lg:text-xl');
const SPAN_CLASSES = ({
  highlighted,
  active,
  highlightColor,
